(function () {
  Vue.component("reports-v3-programs--evaluations--course-recommendations", {
    props: {
      programs: {
        type: Array,
        default: function () {
    ...
    computed: {
      ...
      selectedRecommendationTags() {
        const value = this.selectedFilters?.course_recommendation_tags;
      ...
      reportFilterControls() {
        return [
          {
            type: "multiselect",
            key: "course_recommendation_tags",
