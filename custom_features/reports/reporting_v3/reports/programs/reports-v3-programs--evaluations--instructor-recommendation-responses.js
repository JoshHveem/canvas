(function () {
  Vue.component("reports-v3-programs--evaluations--instructor-recommendation-responses", {
    props: {
      programs: {
        type: Array,
        default: function () {
    ...
    computed: {
      ...
      selectedTags() {
        const value = this.selectedFilters?.instructor_recommendation_response_tags;
      ...
      reportFilterControls() {
        return [
          {
            type: "multiselect",
            key: "instructor_recommendation_response_tags",
            label: "Tags",
    ...
    template: `
      <div style="margin-top:18px;">
        <div v-if="!selectedProgramCode" class="btech-card btech-theme" style="padding:16px;">
          <div style="font-weight:600; margin-bottom:4px;">Instructor Recommendation Responses</div>
          <div class="btech-muted">Select a program in Filters to view instructor recommendation responses.</div>
        </div>

        <div v-else-if="loading" class="btech-card btech-theme" style="padding:16px;">
          <div class="btech-muted">Loading instructor recommendation responses...</div>
        </div>

        <div v-else-if="error" class="btech-card btech-theme" style="padding:16px; border-color:#fecaca; background:#fef2f2;">
          <div style="font-weight:600; margin-bottom:4px;">Instructor Recommendation Responses Error</div>
