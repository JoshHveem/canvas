...
Vue.component('departments-canvas', {
  ...
  created() {
    this.table.setColumns([
        ...
        //     d => d?.canvas?.quiz_questions_total ?? '0',
        //     null,
        ...
        new window.ReportColumn(
            ...
            d => d?.canvas?.content_created_recent ?? '0',
            null,
        ...
        //     d => d?.canvas?.content_updated_recent ?? '0',
        //     null,
        ...
        new window.ReportColumn(
            ...
            d => d?.canvas?.kaltura_videos_created ?? '0',
            null,
        ...
        new window.ReportColumn(
            ...
            d => d?.canvas?.kaltura_videos_created_recent ?? '0',
            null,
