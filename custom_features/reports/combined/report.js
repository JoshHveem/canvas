...
(async function () {
  ...
  async function _init() {
    ...
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features/reports/combined/components/message-template-menu.js") : "https://bridgetools.dev/canvas/custom_features/reports/combined/components/message-template-menu.js");
