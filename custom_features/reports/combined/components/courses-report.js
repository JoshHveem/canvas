  ...
  data() {
    return {
      ...
      columns: [
        ...
        new CoursesColumn('Credits', 'The credits value of the course.', '5rem', false, 'number',
          c => Math.round(c.credits) || 0
        ),
        new CoursesColumn('Credits per Week', 'Avg credits/week earned by students.', '8rem', true, 'number',
