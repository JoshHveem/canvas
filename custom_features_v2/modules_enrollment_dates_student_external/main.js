/*
  ...
  (async function() {
    await $.getScript("https://bridgetools.dev/canvas/custom_features_v2/modules_enrollment_dates_student_external/main.bundle.js");
  })()
    ...
    */
    initCountdown: function() {
      ...
      groups.forEach((capName) => {
        ...
        $("#btech-countdown").attr('title',  `Course End Date: ${bridgetools.dateToString(this.enrollment.end_at)}`)
      })
    },
