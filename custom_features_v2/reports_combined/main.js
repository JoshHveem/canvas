...
(async function () {
  ...
  async function postLoad() {
    let vueString = '';
    await $.get(
      (window.btechAssetUrl ? window.btechAssetUrl(SOURCE_URL + `/custom_features_v2/reports_combined/template.vue`) : SOURCE_URL + `/custom_features_v2/reports_combined/template.vue`),
      null,
      function (html) {
      ...
      data: function () {
        ...
        const reports = [
          ...
          },
          {
            value: 'graduation',
            label: 'Graduation',
            title: 'Graduation Outlook Report',
            subMenus: [
              {
                value: 'summary',
                label: 'Summary',
                component: 'reports-graduation-summary',
  ...
  async function _init() {
    ...
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/components/report-mixins.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/components/report-mixins.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/components/submission-history-graph.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/components/submission-history-graph.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/components/message-template-menu.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/components/message-template-menu.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/components/report-table-shell.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/components/report-table-shell.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/departments-syllabi.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/departments-syllabi.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/departments-course-readiness.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/departments-course-readiness.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/department-instructors.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/department-instructors.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/department-syllabi.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/department-syllabi.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/department-course-readiness.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/department-course-readiness.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/outcomes-cpl.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/outcomes-cpl.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/outcomes-cpl-historic.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/outcomes-cpl-historic.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/employment-skills.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/employment-skills.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/students-at-a-glance.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/students-at-a-glance.js");
    ...
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/placements-locations.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/placements-locations.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-course-summary.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-course-summary.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-course-evals-by-course.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-course-evals-by-course.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-course-detail.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-course-detail.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-instructor-summary.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-instructor-summary.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-instructor-evals-by-course.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-instructor-evals-by-course.js");
    await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-instructor-detail.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/evaluations-instructor-detail.js");
    if (IS_ISD) await $.getScript(window.btechAssetUrl ? window.btechAssetUrl("https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/admissions-overview.js") : "https://bridgetools.dev/canvas/custom_features_v2/reports_combined/reports/admissions-overview.js");
